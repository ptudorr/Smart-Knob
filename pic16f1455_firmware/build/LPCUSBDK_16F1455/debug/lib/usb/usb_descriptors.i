...
# 2 "<built-in>" 2
# 1 "lib/usb/usb_descriptors.c" 2
# 141 "lib/usb/usb_descriptors.c"
...
# 141 "lib/usb/usb_descriptors.c" 2
...
# 142 "lib/usb/usb_descriptors.c" 2
...
const struct{uint8_t report[87];}HAPTIC_rpt={{
...
const struct{uint8_t report[28];}LED_rpt={{
  0x05,0x08,
  0x09,0x52,
  0xA1,0x02,
...
const struct{uint8_t report[22];}DISPLAY_rpt={{
  0x05,0x14,
  0x09,0x02,
  0xA1,0x02,

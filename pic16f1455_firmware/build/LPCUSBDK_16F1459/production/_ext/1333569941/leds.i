# 1 "../../../../../../bsp/low_pin_count_usb_development_kit/pic16f1459/leds.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../../../bsp/low_pin_count_usb_development_kit/pic16f1459/leds.c" 2
# 23 "../../../../../../bsp/low_pin_count_usb_development_kit/pic16f1459/leds.c"
# 1 "../../../../../../bsp/low_pin_count_usb_development_kit/pic16f1459\\leds.h" 1
# 26 "../../../../../../bsp/low_pin_count_usb_development_kit/pic16f1459\\leds.h"
# 1 "E:\\Atmel Studio\\Comp-istall\\pic\\include\\c99\\stdbool.h" 1 3
# 26 "../../../../../../bsp/low_pin_count_usb_development_kit/pic16f1459\\leds.h" 2
...
# 23 "../../../../../../bsp/low_pin_count_usb_development_kit/pic16f1459/leds.c" 2
...
# 25 "../../../../../../bsp/low_pin_count_usb_development_kit/pic16f1459/leds.c" 2
# 59 "../../../../../../bsp/low_pin_count_usb_development_kit/pic16f1459/leds.c"
void LED_On(LED led)
{
    switch(led)
    {
...
# 100 "../../../../../../bsp/low_pin_count_usb_development_kit/pic16f1459/leds.c"
void LED_Off(LED led)
{
    switch(led)
    {
...
# 141 "../../../../../../bsp/low_pin_count_usb_development_kit/pic16f1459/leds.c"
void LED_Toggle(LED led)
{
    switch(led)
    {
...
# 182 "../../../../../../bsp/low_pin_count_usb_development_kit/pic16f1459/leds.c"
_Bool LED_Get(LED led)
{
    switch(led)
    {
        case LED_D1:
            return ( (LATCbits.LATC0 == 1) ? 1 : 0 );

        case LED_D2:
            return ( (LATCbits.LATC1 == 1) ? 1 : 0 );

        case LED_D3:
            return ( (LATCbits.LATC2 == 1) ? 1 : 0 );

        case LED_D4:
            return ( (LATCbits.LATC3 == 1) ? 1 : 0 );
...
# 220 "../../../../../../bsp/low_pin_count_usb_development_kit/pic16f1459/leds.c"
void LED_Enable(LED led)
{
    switch(led)
    {

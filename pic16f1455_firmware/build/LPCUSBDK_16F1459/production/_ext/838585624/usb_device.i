...
# 36 "../../../../../../framework/usb/inc/usb_hal_pic16f1.h"
...
volatile BDT_ENTRY BDT[((1 + 1) * 4)] __attribute__((address(0x2000)));




volatile CTRL_TRF_SETUP SetupPkt __attribute__((address(0x2000 + (4 * ((1 + 1) * 4)))));
volatile uint8_t CtrlTrfData[8] __attribute__((address(0x2000 + (4 * ((1 + 1) * 4)) + 8)));
...
void USBDeviceInit(void)
{
    ...
    { uint8_t i; uint8_t* p = (uint8_t*)&UEP1; for(i=0;i<1;i++) *p++ = 0; };
...
{
    uint8_t i;
# 509 "../../../../../../framework/usb/src/usb_device.c"
    if (1 != 1)
    {
         ...
         USBDeviceState = DETACHED_STATE;
# 546 "../../../../../../framework/usb/src/usb_device.c"
         PIR2bits.USBIF = 0;;
         return;
    }
# 570 "../../../../../../framework/usb/src/usb_device.c"
...
uint32_t USBGet1msTickCount(void)
{
# 3093 "../../../../../../framework/usb/src/usb_device.c"

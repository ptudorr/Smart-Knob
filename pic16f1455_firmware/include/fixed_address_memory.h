...
#define HAPTIC_IN_ADDRESS_HI 20
#define HAPTIC_IN_ADDRESS_LO 50
...
#define HPIN_ADDR_HEX ADD0X(M_CONC(HAPTIC_IN_ADDRESS_HI,HAPTIC_IN_ADDRESS_LO))

#if(__XC8_VERSION < 2000)
    #define HAPTIC_IN_DATA_ADDRESS @0x2050
    #define HID_CUSTOM_IN_DATA_BUFFER_ADDRESS @0x20A0
#else
    #define HAPTIC_IN_DATA_ADDRESS __at(HPIN_ADDR_HEX)//IN 32 bytes
